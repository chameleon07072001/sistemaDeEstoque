...
public abstract class SistemaDeEstoque extends JFrame implements ActionListener{
    ...
    ImageIcon img = new ImageIcon(getClass().getResource("pq.png"));
    ImageIcon img2 = new ImageIcon(getClass().getResource("fornecedor.png"));
    ImageIcon img3 = new ImageIcon(getClass().getResource("produto.png"));
    ImageIcon img4 = new ImageIcon(getClass().getResource("venda.png"));
